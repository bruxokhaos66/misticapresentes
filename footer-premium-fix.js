  ...
  function installFooterStyle() {
    ...
    style.textContent = `
      .contact-section {
        position: relative;
        overflow: hidden;
        border-top: 1px solid rgba(240,197,106,.18);
        border-bottom: 1px solid rgba(240,197,106,.16);
        background:
          radial-gradient(circle at 12% 18%, rgba(240,197,106,.14), transparent 30rem),
          radial-gradient(circle at 84% 78%, rgba(184,201,119,.12), transparent 28rem),
          linear-gradient(180deg, rgba(8,7,13,.94), rgba(3,3,5,.98));
      }
      .contact-section .split {
        align-items: stretch;
        gap: clamp(18px, 3vw, 34px);
      }
      .contact-section .split > div:first-child,
      .contact-section .contact-card {
        border: 1px solid rgba(240,197,106,.24);
        border-radius: clamp(24px, 3vw, 36px);
        padding: clamp(24px, 4vw, 42px);
        background:
          radial-gradient(circle at 18% 12%, rgba(240,197,106,.14), transparent 34%),
          linear-gradient(145deg, rgba(255,248,230,.075), rgba(83,107,55,.075)),
          rgba(3,3,5,.32);
      ...
      .footer {
        ...
        overflow: hidden;
        padding: 28px 0 92px;
        border-top: 1px solid rgba(240,197,106,.20);
        background:
          radial-gradient(circle at 50% 0, rgba(240,197,106,.10), transparent 30rem),
      ...
      @media (max-width: 680px) {
        ...
        .footer-grid > div:first-child { border-radius: 24px; align-items: flex-start; justify-content: flex-start; }
        .contact-section .split > div:first-child,
        .contact-section .contact-card { border-radius: 24px; }
      }
    `;
