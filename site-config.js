...
(() => {
  const css = `
    ...
    .brand-hero:after{content:""!important;position:absolute!important;inset:0!important;background:radial-gradient(circle at 72% 28%,rgba(240,197,106,.16),transparent 24%),radial-gradient(circle at 90% 74%,rgba(126,63,242,.16),transparent 28%)!important;opacity:.65!important;pointer-events:none!important;mix-blend-mode:normal!important}
    .brand-hero .hero-grid{grid-template-columns:minmax(0,.92fr) minmax(360px,.98fr)!important;align-items:center!important;gap:clamp(26px,4vw,58px)!important}
    .brand-hero h1{max-width:640px!important;text-transform:uppercase!important;font-size:clamp(2.35rem,4.6vw,4.35rem)!important;line-height:1.03!important;letter-spacing:.04em!important;background:linear-gradient(180deg,#fff6dc 0%,#efc168 48%,#b8ca75 100%)!important;-webkit-background-clip:text!important;background-clip:text!important;color:transparent!important}
    .hero-text{max-width:560px!important;font-size:clamp(1rem,1.28vw,1.16rem)!important;line-height:1.62!important;color:#f1e4d1!important}
    .hero-card-isis{min-height:560px!important;padding:18px!important;display:grid!important;align-content:center!important;justify-items:center!important;border:1px solid rgba(240,197,106,.24)!important;background:radial-gradient(circle at 55% 22%,rgba(240,197,106,.20),transparent 34%),linear-gradient(145deg,rgba(12,9,18,.72),rgba(20,31,15,.30))!important;box-shadow:0 24px 70px rgba(0,0,0,.38)!important}
    .hero-card-isis>img{content:url('assets/isis-humana-premium.webp?v=20260705p')!important;display:block!important;opacity:1!important;visibility:visible!important;width:100%!important;max-width:560px!important;max-height:620px!important;object-fit:contain!important;border-radius:28px!important;filter:drop-shadow(0 32px 70px rgba(0,0,0,.54))!important}
    .hero-card-isis .floating-card{z-index:3!important}
    ...
    @media(max-width:560px){.nav{min-height:76px!important}.brand img,.footer img{width:48px!important;height:48px!important}.brand-copy strong{font-size:1rem!important}.hero-copy h1{font-size:clamp(2rem,10.4vw,3.25rem)!important}.hero-card-isis>img{max-height:520px!important}}
  `;
  const apply = () => {
