...
(() => {
  ...
  const css = `
    ...
    @media(max-width:1180px){.brand-hero .hero-grid{grid-template-columns:1fr!important}.hero-card-isis{min-height:560px!important}.brand-copy strong{max-width:260px!important}.nav{min-height:92px!important}}
    @media(max-width:560px){.nav{min-height:76px!important}.brand img,.footer img{width:48px!important;height:48px!important}.brand-copy strong{font-size:1rem!important}.hero-copy h1{font-size:clamp(2rem,10.4vw,3.25rem)!important}.hero-card-isis{min-height:440px!important}.hero-card-isis>img{max-height:520px!important}.hero-card-isis .floating-card{position:static!important;margin-top:12px!important}}
  `;
  const apply = () => {
