def aplicar_patches_runtime(fonte):
    ...
    def montar_frajola(self):
        try:
            ...
            self.frajola_status_label = ctk.CTkLabel(esquerda, text="", font=("Arial", 16, "bold"), text_color=self.cor_ouro, wraplength=440, justify="center")
            self.frajola_status_label.pack(pady=8)

            self.frajola_evento_label = ctk.CTkLabel(esquerda, text="", font=("Arial", 14), text_color="#f0e6d2", wraplength=460, justify="center")
            ...
            acoes = [
                ...
                ("❤️ Disciplinar", "disciplinar"), ("🔔 Atender", "atender"), ("🔄 Reiniciar", "reiniciar"),
            ]
