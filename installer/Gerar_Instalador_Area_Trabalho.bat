...
python -m PyInstaller --noconfirm --onedir --windowed --name "MisticaPresentes" --add-data "mistica_presentes.py;." --add-data "app_runtime_patch.py;." --add-data "app_sync_status_patch.py;." --add-data "app_scroll_patch.py;." --add-data "config.py;." --add-data "database;database" --add-data "services;services" --add-data "isis;isis" --add-data "backend;backend" app.py
